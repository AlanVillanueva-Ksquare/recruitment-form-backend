...
exports.GovernmentInfoRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const governmentInfo = yield (0, GovernmentInfo_repo_1.getGovernmentInfoById)(id);
        if (governmentInfo) {
...
exports.GovernmentInfoRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedGovernmentInfo = yield (0, GovernmentInfo_repo_1.updateGovernmentInfoById)(id, data);
...
exports.GovernmentInfoRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const success = yield (0, GovernmentInfo_repo_1.deleteGovernmentInfoById)(id);
        if (success) {
