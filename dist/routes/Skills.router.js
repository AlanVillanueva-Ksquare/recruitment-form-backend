...
exports.SkillsRouter.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = req.body;
        const newSkill = yield (0, Skills_repo_1.createSkill)(data);
        if (newSkill) {
...
exports.SkillsRouter.get("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const skill = yield (0, Skills_repo_1.getSkillById)(id);
        if (skill) {
...
exports.SkillsRouter.put("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedSkill = yield (0, Skills_repo_1.updateSkillById)(id, data);
        if (updatedSkill) {
...
exports.SkillsRouter.delete("/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const success = yield (0, Skills_repo_1.deleteSkillById)(id);
        if (success) {
